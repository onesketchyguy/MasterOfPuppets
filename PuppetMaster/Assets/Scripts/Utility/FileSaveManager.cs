...
namespace FileSystem
{
    ...
    public class ColorSerializationSurrogate : ISerializationSurrogate
    {
        ...
        {
            var quaternion = (Color)obj;
            info.AddValue("r", quaternion.r);
            info.AddValue("g", quaternion.g);
            info.AddValue("b", quaternion.b);
            info.AddValue("a", quaternion.a);
        }

        public object SetObjectData(object obj, SerializationInfo info, StreamingContext context, ISurrogateSelector selector)
        {
            var quaternion = (Color)obj;
            quaternion.r = (float)info.GetValue("r", typeof(float));
            quaternion.g = (float)info.GetValue("g", typeof(float));
            quaternion.b = (float)info.GetValue("b", typeof(float));
            quaternion.a = (float)info.GetValue("a", typeof(float));
